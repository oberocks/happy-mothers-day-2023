...
appVv.buttons.palettes.outline = {
    ...
    primary: 'text-violet-500 dark:text-violet-300 hover:text-white dark:hover:text-white focus:text-white dark:focus:text-white hover:bg-violet-500 focus:bg-violet-500 active:bg-violet-600 border-violet-300 hover:border-violet-500 focus:ring-violet-400 dark:focus:ring-violet-200 focus:border-violet-50 dark:focus:border-violet-900',
...
appVv.buttons.palettes.solid = {
    ...
    primary: 'text-white bg-violet-500 hover:bg-violet-600 focus:bg-violet-600 active:bg-violet-700 border-violet-500 hover:border-violet-600 focus:border-violet-100 dark:focus:border-violet-900 focus:ring-violet-600 dark:focus:ring-violet-200',
...
appVv.checkboxes.palettes.default = {
    ...
    primary: 'focus:ring-violet-500 text-violet-500 dark:focus:ring-violet-200 dark:text-violet-300',
...
appVv.grounds.palettes.console = {
    ...
    primary: 'font-mono text-violet-200 bg-gray-800 bg-opacity-100 dark:bg-black dark:bg-opacity-80',
...
appVv.inputs.palettes.default = {
    default: 'focus:ring-violet-500 focus:border-violet-500 dark:focus:ring-violet-400 dark:focus:border-violet-400 border-gray-300 dark:border-gray-600 bg-gray-50 focus:bg-white dark:bg-gray-800 dark:focus:bg-gray-700 placeholder:text-gray-400 placeholder:dark:text-gray-300 selection:bg-violet-600 dark:selection:bg-violet-500 selection:text-white',
...
appVv.inputs.palettes.underlined = {
    default: 'focus:ring-0 border-x-0 border-t-0 border-b-2 focus:border-b-violet-500 focus:border-x-gray-700 dark:focus:border-b-violet-400 border-b-gray-300 dark:border-b-gray-600 bg-gray-50 focus:bg-white dark:bg-gray-800 dark:focus:bg-gray-700 selection:bg-violet-600 dark:selection:bg-violet-500 selection:text-white',
...
appVv.listboxes.buttonPalettes.default = {
    default: 'focus:ring-violet-500 focus:border-violet-500 dark:focus:ring-violet-400 dark:focus:border-violet-400 border-gray-300 dark:border-gray-600 bg-gray-50 focus:bg-white hover:bg-white dark:bg-gray-800 dark:focus:bg-gray-700 dark:hover:bg-gray-700 border-gray-500',
...
appVv.listboxes.buttonPalettes.underlined = {
    default: 'focus:ring-0 border-x-0 border-t-0 border-b-2 focus:border-b-violet-500 focus:border-x-gray-700 dark:focus:border-b-violet-400 border-b-gray-300 dark:border-b-gray-600 bg-gray-50 focus:bg-white hover:bg-white dark:bg-gray-800 dark:focus:bg-gray-700 dark:hover:bg-gray-700 border-gray-500',
...
appVv.listboxes.optionPalettes.default = {
    default: 'ui-active:font-bold ui-active:bg-violet-500 ui-active:text-white ui-not-active:bg-white ui-not-active:text-gray-900 dark:ui-not-active:bg-gray-700 dark:ui-not-active:text-white',
...
appVv.listboxes.optionPalettes.underlined = {
    default: 'ui-active:font-bold ui-active:bg-white dark:ui-active:bg-gray-700 ui-active:text-violet-500 dark:ui-active:text-violet-300 ui-not-active:bg-white ui-not-active:text-gray-900 dark:ui-not-active:bg-gray-700 dark:ui-not-active:text-white',
...
appVv.scrollbars.palettes.default = {
    ...
    primary: 'scrollbar scrollbar-thumb-violet-100 scrollbar-track-violet-200 dark:scrollbar-thumb-violet-600 dark:scrollbar-track-violet-800',
